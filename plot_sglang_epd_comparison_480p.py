...
OUTPUT_FILE = "/hongming/dynamo/sglang_epd_qwen32_fp8_128_256_20_images_480p_all.png"

# Define configurations to compare
configs = {
    "H200 Agg TP1": {
        "path": RESULTS_BASE / "agg_480p_tp1_h200_32b_image20",
        "color": "#FF6B6B",
        "marker": "o"
    },
    "H200 Agg TP2": {
    ...
    "H200 Disagg": {
        "path": RESULTS_BASE / "disagg_480p_h200_h200_32b_image20",
        "color": "#FFE66D",
        "marker": "^"
    }
}
...
def create_plot():
    ...
    fig.suptitle('EPD Disaggregation\nQwen3-VL-32B-FP8 | 128 input / 256 output tokens | 20 images Per Request | 480p',
