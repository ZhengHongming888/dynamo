...
# This starts: 2 Encode workers on Intel XPU devices 3 and 4 for multimodal processing
...
# XPU Devices
export XPU_DEVICE_1=3  # First Intel XPU device ID (for ZE_AFFINITY_MASK)
...
# Start Intel XPU Encode Worker 1 on Device 3
...
# Start Intel XPU Encode Worker 2 on Device 4
echo ""
