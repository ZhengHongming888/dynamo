...
# XPU Device
export XPU_DEVICE=2  # Intel XPU device ID (for ZE_AFFINITY_MASK)
...
#--model-path /software/data/pytorch/huggingface/hub/models--Qwen--Qwen2.5-VL-3B-Instruct/snapshots/66285546d2b821cf421d4f5eb2576359d3770cd3 \
