...
#           giga01 NIC = mlx5_4 (192.165.123.52, NUMA 2, paired with CUDA_DEVICE_PD=4)
#
...
# XPU Device (Battlemage Pro 70) - 0..7. Default 0 (NUMA 0).
...
echo ""
echo "Starting Intel B70 XPU Encode Worker (32B FP8)..."
...
python3 -m dynamo.sglang \
    ...
    2>&1 | tee -a "$LOG_DIR/encode_xpu_32b_b70.log" &
...
echo ""
echo "Log:    $LOG_DIR/encode_xpu_32b_b70.log"
echo "Tail:   tail -f $LOG_DIR/encode_xpu_32b_b70.log"
echo "Ready:  grep -i 'registered\\|ready' $LOG_DIR/encode_xpu_32b_b70.log"
