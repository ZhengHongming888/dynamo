#!/bin/bash
# Start script for Dynamo SGLang Disaggregated Prefill/Decode (3x Intel XPU Encode Workers)
# Model: Qwen3-VL-32B-Instruct-FP8
# This starts: 3 Encode workers on Intel XPU devices for multimodal processing
...
# XPU Devices - Choose 3 different devices from: 0, 1, 2, 3, 4, 5, 6, 7
...
export UCX_NIC_3=mlx5_1:1         # InfiniBand NIC for encoder 3 (reuse mlx5_1:1)
...
echo "=========================================="
echo "Dynamo SGLang 3x Intel XPU Encode Workers"
echo "Model: Qwen3-VL-32B-Instruct-FP8"
echo "=========================================="
echo ""
echo "Remote CUDA server: $IP_REMOTE"
echo "Local XPU server:   $IP_LOCAL"
echo "XPU Devices:        $XPU_DEVICE_1, $XPU_DEVICE_2, $XPU_DEVICE_3"
echo ""
...
echo ""
echo "=========================================="
echo "3x Intel XPU Encode Workers Started"
echo "Model: Qwen3-VL-32B-Instruct-FP8"
echo "=========================================="
echo ""
echo "Configuration:"
...
echo "  ✓ Dedicated InfiniBand NICs per encoder (minimal contention)"
...
echo "  • Total XPU memory: ~6-12GB for three encoders"
echo "  • Load time: ~5-10 minutes per encoder (~30 min total with delays)"
...
echo "  tail -f $LOG_DIR/encode_xpu_32b_3.log"
echo ""
echo "To check when ready:"
echo "  grep -i 'registered\\|ready\\|succeeded' $LOG_DIR/encode_xpu_32b_{1,2,3}.log"
echo ""
echo "To stop all encode workers:"
echo "  kill $ENCODE_PID_1 $ENCODE_PID_2 $ENCODE_PID_3"
echo "  # or: pkill -f 'dynamo.sglang.*multimodal-encode-worker.*32B'"
echo ""
echo "Performance tip:"
echo "  Monitor all three encoders to ensure balanced load distribution"
echo "  Each encoder should process ~33% of incoming multimodal requests"
echo ""
