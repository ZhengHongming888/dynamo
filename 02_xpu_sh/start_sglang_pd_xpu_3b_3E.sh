...
# This starts: 3 Encode workers on Intel XPU devices 0, 1, and 3 for multimodal processing
...
# XPU Devices (using cleanest idle devices: 0, 1, 3)
...
# Start Intel XPU Encode Worker 1 on Device 0
...
# Start Intel XPU Encode Worker 2 on Device 1
echo ""
...
# Start Intel XPU Encode Worker 3 on Device 3
echo ""
