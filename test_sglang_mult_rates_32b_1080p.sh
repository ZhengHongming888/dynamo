...
# Usage: ./test_sglang_mult_rates_32b_1080p.sh [rates...]
# Example: ./test_sglang_mult_rates_32b_1080p.sh 0.1 0.2 0.3
#          ./test_sglang_mult_rates_32b_1080p.sh  # uses default rates
...
NUM_PROMPTS=128  # Fixed at 64 for all rates
...
#TEST_DIR="/hongming/res/b70_h200_4E_disagg_32b_image4_768p_numprompt32/test_sglang_multi_rates_768p_${TIMESTAMP}"
#TEST_DIR="/hongming/res/h200_agg_tp2_32b_image4_768p_numprompt32/test_sglang_multi_rates_768p_${TIMESTAMP}"
TEST_DIR="/hongming/res/h200_h200_disagg_32b_image4_768p_n128_new/test_sglang_multi_rates_768p_${TIMESTAMP}"
mkdir -p "$TEST_DIR"
...
echo "Rates:       ${RATES[*]}"
echo "Num Prompts: $NUM_PROMPTS (fixed for all rates)"
...
# Also save the table output to a file
{
    echo "BENCHMARK SUMMARY - ALL RATES (32B FP8 1080p)"
    echo "Generated: $(date)"
    echo "Configuration: 8 images at 1920x1080, 64 prompts per rate"
    echo ""
    echo "=== Request Throughput & Latency ==="
    printf "%-12s %-12s %-12s %-12s %-12s %-12s %-12s\n" \
        "Target_RPS" "Actual_RPS" "Success" "Mean_E2E" "Median_E2E" "P99_E2E" "Concurrency"
