#!/bin/bash
# 8 images at 768p (1024x768) - rate sweep
# Usage: ./test_sglang_8img_768p_sweep.sh [rates...]
# Default sweep: 0.1, 0.25, 0.5, 1.0, 1.25 (matches 1080p rate sweep)
...
# Rate sweep matching the 1080p np64 sweep convention
