#!/bin/bash
# 32 images at 1080p - vision-encoder-stress test
# Predicted ViT/(ViT+LLM) ratio ~42% — close to the regime where disagg should win.
# Usage: ./test_sglang_32img_1080p.sh [rates...]
# Default: rate=1.0
...
# Default rate: 1.0 (matches earlier comparisons)
DEFAULT_RATES=(1.0)
