#!/bin/bash
# 8 images at 768p (1024x768) - prefill-heavy but smaller per-image footprint than 1080p
# Usage: ./test_sglang_8img_768p.sh [rates...]
# Default: rate=1.0 (matches the 1080p comparison)
...
# Default rate: 1.0 (matches 1080p comparison rate)
DEFAULT_RATES=(1.0)
