...
IMAGE_RESOLUTION="(1024, 768, 1)"  # 480p (SD)
REQUEST_RATES=(0.2 0.5 0.8 1.0 1.2 1.5 2.0)  # Extended rate range for detailed analysis
SPLIT_RATIO="8:1"  # XPU:CPU ratio

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
OUTPUT_BASE_DIR="/workspace/benchmark_dual_encoder_light_3B_image8_request32_ratio81_res1024_${TIMESTAMP}"
...
export DYN_ENCODE_WORKER_1_GPU=3
export DYN_PREFILL_WORKER_GPU=4
export DYN_DECODE_WORKER_GPU=5
