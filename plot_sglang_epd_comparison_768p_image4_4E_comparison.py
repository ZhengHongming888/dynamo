#!/usr/bin/env python3
"""
Script to generate comparison plots for SGLang EPD benchmarks across B70-H200 disaggregation configurations.
Compares 1E, 2E, 3E, and 4E encoder setups with 768p images.
"""
...
OUTPUT_FILE = "/hongming/dynamo/sglang_epd_qwen32_fp8_b70_h200_768p_image4_4E_comparison.png"

# Define configurations to compare
configs = {
    "B70-H200 1E+1PD": {
        "path": RESULTS_BASE / "b70_h200_disagg_32b_image4_768p_numprompt32",
        "color": "#FF6B6B",
        "marker": "o"
    },
    "B70-H200 2E+1PD": {
        "path": RESULTS_BASE / "b70_h200_2E_disagg_32b_image4_768p_numprompt32",
        "color": "#4ECDC4",
        "marker": "s"
    },
    "B70-H200 3E+1PD": {
        "path": RESULTS_BASE / "b70_h200_3E_disagg_32b_image4_768p_numprompt32",
        "color": "#FFE66D",
        "marker": "^"
    },
    "B70-H200 4E+1PD": {
        "path": RESULTS_BASE / "b70_h200_4E_disagg_32b_image4_768p_numprompt32",
        "color": "#95E1D3",
        "marker": "D"
    }
}
...
def create_plot():
    ...
    for idx, (metric, title, xlabel, ylabel) in enumerate(metrics):
        ...
        # Plot in reverse order so 1E appears on top when overlapping
