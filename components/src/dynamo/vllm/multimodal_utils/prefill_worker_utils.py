        ...
        if ENCODER_SCHEDULER_MODE == "per_request":
            ...
            if len(instance_ids) == 2:
                ...
                if encoder_device_mapping:
                    encoder_type = encoder_device_mapping.get(selected_instance_id, "unknown").upper()
                else:
...
class MultiModalEmbeddingLoader:
    ...
    def __init__(
        ...
        self._encoder_device_mapping = encoder_device_mapping if encoder_device_mapping else {}
