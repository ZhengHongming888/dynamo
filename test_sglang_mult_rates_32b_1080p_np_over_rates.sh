...
# For 1080p: use 32, 64, 128, 256 num_prompts for 0.1, 0.25, 0.5, 1.0 QPS respectively
...
#TEST_DIR="/hongming/res/b70_h200_4E_disagg_32b_image4_768p_np_rates/test_sglang_multi_rates_768p_${TIMESTAMP}"
TEST_DIR="/hongming/res3/h200_agg_tp2_32b_image8_1080p_np_rates/test_sglang_multi_rates_1080p_${TIMESTAMP}"
#TEST_DIR="/hongming/res/h200_h200_disagg_32b_image4_768p_np_rates/test_sglang_multi_rates_768p_${TIMESTAMP}"
mkdir -p "$TEST_DIR"
