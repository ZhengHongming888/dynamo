#!/bin/bash
# Run multiple rate tests for SGLang benchmark - Qwen3-VL-8B-Instruct with 8 images at 1080p
# (cloned from test_sglang_mult_rates_32b_1080p_np64_over_rates.sh; only model path changed)
# Usage: ./test_sglang_8b_1080p_np64_over_rates.sh [rates...]
# Example: ./test_sglang_8b_1080p_np64_over_rates.sh 0.1 0.5 1.0
#          ./test_sglang_8b_1080p_np64_over_rates.sh  # uses default rates
...
RESULT_BASE="${RESULT_BASE:-/hongming/res7_8B/h200_agg_tp1_8b_image8_1080p_np64_rates}"
TEST_DIR="${RESULT_BASE}/test_sglang_multi_rates_1080p_${TIMESTAMP}"
mkdir -p "$TEST_DIR"

echo "=========================================="
echo "SGLang Multi-Rate Benchmark - 8B (1080p)"
echo "=========================================="
echo "Model:       $MODEL"
echo "Port:        $PORT"
...
echo ""
echo "=========================================="
echo "BENCHMARK SUMMARY - ALL RATES (8B 1080p)"
echo "=========================================="
echo ""
