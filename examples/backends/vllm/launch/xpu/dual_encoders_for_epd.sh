...
# GPU assignments
DYN_ENCODE_WORKER_1_GPU=${DYN_ENCODE_WORKER_1_GPU:-3}  # For XPU encoder
DYN_PREFILL_WORKER_GPU=${DYN_PREFILL_WORKER_GPU:-4}
DYN_DECODE_WORKER_GPU=${DYN_DECODE_WORKER_GPU:-5}
