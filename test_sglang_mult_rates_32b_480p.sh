#!/bin/bash
# Run multiple rate tests for SGLang benchmark - 32B FP8 model with 20 images at 480p
# Usage: ./test_sglang_mult_rates_32b_480p.sh [rates...]
# Example: ./test_sglang_mult_rates_32b_480p.sh 0.1 0.2 0.3
#          ./test_sglang_mult_rates_32b_480p.sh  # uses default rates
...
# Default rates for 32B model with 20 images
# For 20 images: use 32, 64, 128, 256 num_prompts for 0.1, 0.25, 0.5, 1.0 QPS respectively
DEFAULT_RATES=(0.1 0.25 0.5 1.0)
declare -A NUM_PROMPTS_MAP
NUM_PROMPTS_MAP[0.1]=32
NUM_PROMPTS_MAP[0.25]=64
NUM_PROMPTS_MAP[0.5]=128
NUM_PROMPTS_MAP[1.0]=256
...
TEST_DIR="/hongming/res/h200_h200_z_disagg_32b_image20/test_sglang_multi_rates_480p_${TIMESTAMP}"
mkdir -p "$TEST_DIR"

echo "=========================================="
echo "SGLang Multi-Rate Benchmark - 32B FP8 (480p)"
echo "=========================================="
echo "Model:       $MODEL"
echo "Port:        $PORT"
echo "Images:      $NUM_IMAGES (20 images per request)"
echo "Resolution:  $IMAGE_RESOLUTION"
echo "Input Len:   $INPUT_LEN"
echo "Output Len:  $OUTPUT_LEN"
echo "Rates:       ${RATES[*]}"
echo "Num Prompts: Dynamic (32@0.1, 64@0.25, 128@0.5, 256@1.0 QPS)"
...
echo ""
echo "=========================================="
echo "BENCHMARK SUMMARY - ALL RATES (32B FP8)"
echo "=========================================="
echo ""
